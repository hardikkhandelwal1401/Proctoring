  ...
  return (
    <Card>
      <CardContent>
        ...
        <Typography>
          This practice test will allow you to measure your skills at the beginner level by the way
          of various multiple choice questions. We recommend you to score at least 75% in this test
          before moving to the next level questionnaire. It will help you in identifying your
          strength and development areas. Based on the same you can plan your next steps in learning
          Python and preparing for job placements.
        </Typography>

        <Typography>#Coding #Software #MCQ #Beginner #Programming Language</Typography>
        ...
        <>
          ...
          <List>
            <ol>
              ...
              <li>
                <ListItemText>
                  <Typography variant="body1">Clicking on Next will save the answer.</Typography>
                </ListItemText>
              </li>
              <li>
                <ListItemText>
